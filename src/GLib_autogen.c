...
SEXP R_g_bookmark_file_get_app_info(SEXP s1, SEXP s2, SEXP s3) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_exec == NULL) ? R_NilValue : Rf_mkString(_out_exec ? (const char*)_out_exec : ""));
  ...
  SET_VECTOR_ELT(_ans, 3, Rf_ScalarReal((double)(size_t)(_out_stamp)));
...
SEXP R_g_bookmark_file_get_application_info(SEXP s1, SEXP s2, SEXP s3) {
  ...
  SET_STRING_ELT(_ans_names, 2, Rf_mkChar("count"));
  SET_VECTOR_ELT(_ans, 3, (_out_stamp == NULL) ? R_NilValue : R_MakeExternalPtr((void*)(_out_stamp), R_NilValue, R_NilValue));
  SET_STRING_ELT(_ans_names, 3, Rf_mkChar("stamp"));
  Rf_setAttrib(_ans, R_NamesSymbol, _ans_names);
  UNPROTECT(2);
  return _ans;
...
SEXP R_g_bookmark_file_get_icon(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_href == NULL) ? R_NilValue : Rf_mkString(_out_href ? (const char*)_out_href : ""));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("href"));
  SET_VECTOR_ELT(_ans, 2, (_out_mime_type == NULL) ? R_NilValue : Rf_mkString(_out_mime_type ? (const char*)_out_mime_type : ""));
...
SEXP R_g_bookmark_file_load_from_data_dirs(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_full_path == NULL) ? R_NilValue : Rf_mkString(_out_full_path ? (const char*)_out_full_path : ""));
...
SEXP R_g_hash_table_lookup_extended(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, R_MakeExternalPtr((void*)(&_out_orig_key), R_NilValue, R_NilValue));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("orig_key"));
  SET_VECTOR_ELT(_ans, 2, R_MakeExternalPtr((void*)(&_out_value), R_NilValue, R_NilValue));
...
SEXP R_g_hash_table_steal_extended(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, R_MakeExternalPtr((void*)(&_out_stolen_key), R_NilValue, R_NilValue));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("stolen_key"));
  SET_VECTOR_ELT(_ans, 2, R_MakeExternalPtr((void*)(&_out_stolen_value), R_NilValue, R_NilValue));
...
SEXP R_g_hash_table_iter_next(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, R_MakeExternalPtr((void*)(&_out_key), R_NilValue, R_NilValue));
...
SEXP R_g_io_channel_read_line(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, R_MakeExternalPtr((void*)(_ret), R_NilValue, R_NilValue));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_str_return == NULL) ? R_NilValue : Rf_mkString(_out_str_return ? (const char*)_out_str_return : ""));
...
SEXP R_g_io_channel_read_to_end(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, R_MakeExternalPtr((void*)(_ret), R_NilValue, R_NilValue));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_str_return == NULL) ? R_NilValue : Rf_ScalarInteger((int)(_out_str_return)));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("str_return"));
  SET_VECTOR_ELT(_ans, 2, Rf_ScalarInteger((int)(_out_length)));
  SET_STRING_ELT(_ans_names, 2, Rf_mkChar("length"));
  Rf_setAttrib(_ans, R_NamesSymbol, _ans_names);
...
SEXP R_g_key_file_get_boolean_list(SEXP s1, SEXP s2, SEXP s3) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 2));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 2));
  SET_VECTOR_ELT(_ans, 0, (_ret == NULL) ? R_NilValue : Rf_ScalarLogical((int)(size_t)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, Rf_ScalarInteger((int)(_out_length)));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("length"));
  Rf_setAttrib(_ans, R_NamesSymbol, _ans_names);
...
SEXP R_g_key_file_get_double_list(SEXP s1, SEXP s2, SEXP s3) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 2));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 2));
  SET_VECTOR_ELT(_ans, 0, (_ret == NULL) ? R_NilValue : Rf_ScalarReal((double)(size_t)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, Rf_ScalarInteger((int)(_out_length)));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("length"));
  Rf_setAttrib(_ans, R_NamesSymbol, _ans_names);
...
SEXP R_g_key_file_get_integer_list(SEXP s1, SEXP s2, SEXP s3) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 2));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 2));
  SET_VECTOR_ELT(_ans, 0, (_ret == NULL) ? R_NilValue : Rf_ScalarInteger((int)(size_t)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, Rf_ScalarInteger((int)(_out_length)));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("length"));
  Rf_setAttrib(_ans, R_NamesSymbol, _ans_names);
...
SEXP R_g_main_context_query(SEXP s1, SEXP s2, SEXP s3) {
  ...
  SET_VECTOR_ELT(_ans, 2, R_MakeExternalPtr((void*)(&_out_fds), R_NilValue, R_NilValue));
...
SEXP R_g_option_context_parse(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 2, (_out_argv == NULL) ? R_NilValue : Rf_mkString(_out_argv ? (const char*)_out_argv : ""));
...
SEXP R_g_option_context_parse_strv(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_arguments == NULL) ? R_NilValue : Rf_mkString(_out_arguments ? (const char*)_out_arguments : ""));
...
SEXP R_g_regex_match(SEXP s1, SEXP s2, SEXP s3) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_match_info == NULL) ? R_NilValue : R_MakeExternalPtr((void*)(_out_match_info), R_NilValue, R_NilValue));
...
SEXP R_g_time_val_from_iso8601(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, R_MakeExternalPtr((void*)(&_out_time_), R_NilValue, R_NilValue));
...
SEXP R_g_uri_split(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_scheme == NULL) ? R_NilValue : Rf_mkString(_out_scheme ? (const char*)_out_scheme : ""));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("scheme"));
  SET_VECTOR_ELT(_ans, 2, (_out_userinfo == NULL) ? R_NilValue : Rf_mkString(_out_userinfo ? (const char*)_out_userinfo : ""));
  SET_STRING_ELT(_ans_names, 2, Rf_mkChar("userinfo"));
  SET_VECTOR_ELT(_ans, 3, (_out_host == NULL) ? R_NilValue : Rf_mkString(_out_host ? (const char*)_out_host : ""));
  ...
  SET_VECTOR_ELT(_ans, 5, (_out_path == NULL) ? R_NilValue : Rf_mkString(_out_path ? (const char*)_out_path : ""));
  SET_STRING_ELT(_ans_names, 5, Rf_mkChar("path"));
  SET_VECTOR_ELT(_ans, 6, (_out_query == NULL) ? R_NilValue : Rf_mkString(_out_query ? (const char*)_out_query : ""));
  SET_STRING_ELT(_ans_names, 6, Rf_mkChar("query"));
  SET_VECTOR_ELT(_ans, 7, (_out_fragment == NULL) ? R_NilValue : Rf_mkString(_out_fragment ? (const char*)_out_fragment : ""));
...
SEXP R_g_uri_split_network(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 1, (_out_scheme == NULL) ? R_NilValue : Rf_mkString(_out_scheme ? (const char*)_out_scheme : ""));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("scheme"));
  SET_VECTOR_ELT(_ans, 2, (_out_host == NULL) ? R_NilValue : Rf_mkString(_out_host ? (const char*)_out_host : ""));
...
SEXP R_g_uri_split_with_user(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 1, (_out_scheme == NULL) ? R_NilValue : Rf_mkString(_out_scheme ? (const char*)_out_scheme : ""));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("scheme"));
  SET_VECTOR_ELT(_ans, 2, (_out_user == NULL) ? R_NilValue : Rf_mkString(_out_user ? (const char*)_out_user : ""));
  SET_STRING_ELT(_ans_names, 2, Rf_mkChar("user"));
  SET_VECTOR_ELT(_ans, 3, (_out_password == NULL) ? R_NilValue : Rf_mkString(_out_password ? (const char*)_out_password : ""));
  SET_STRING_ELT(_ans_names, 3, Rf_mkChar("password"));
  SET_VECTOR_ELT(_ans, 4, (_out_auth_params == NULL) ? R_NilValue : Rf_mkString(_out_auth_params ? (const char*)_out_auth_params : ""));
  SET_STRING_ELT(_ans_names, 4, Rf_mkChar("auth_params"));
  SET_VECTOR_ELT(_ans, 5, (_out_host == NULL) ? R_NilValue : Rf_mkString(_out_host ? (const char*)_out_host : ""));
  ...
  SET_VECTOR_ELT(_ans, 7, (_out_path == NULL) ? R_NilValue : Rf_mkString(_out_path ? (const char*)_out_path : ""));
  SET_STRING_ELT(_ans_names, 7, Rf_mkChar("path"));
  SET_VECTOR_ELT(_ans, 8, (_out_query == NULL) ? R_NilValue : Rf_mkString(_out_query ? (const char*)_out_query : ""));
  SET_STRING_ELT(_ans_names, 8, Rf_mkChar("query"));
  SET_VECTOR_ELT(_ans, 9, (_out_fragment == NULL) ? R_NilValue : Rf_mkString(_out_fragment ? (const char*)_out_fragment : ""));
...
SEXP R_g_uri_params_iter_next(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_attribute == NULL) ? R_NilValue : Rf_mkString(_out_attribute ? (const char*)_out_attribute : ""));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("attribute"));
  SET_VECTOR_ELT(_ans, 2, (_out_value == NULL) ? R_NilValue : Rf_mkString(_out_value ? (const char*)_out_value : ""));
  SET_STRING_ELT(_ans_names, 2, Rf_mkChar("value"));
  Rf_setAttrib(_ans, R_NamesSymbol, _ans_names);
  UNPROTECT(2);
  return _ans;
...
SEXP R_g_variant_type_string_scan(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_endptr == NULL) ? R_NilValue : Rf_mkString(_out_endptr ? (const char*)_out_endptr : ""));
...
SEXP R_g_file_open_tmp(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_name_used == NULL) ? R_NilValue : Rf_mkString(_out_name_used ? (const char*)_out_name_used : ""));
...
SEXP R_g_filename_from_uri(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, (_ret == NULL) ? R_NilValue : Rf_mkString(_ret ? (const char*)_ret : ""));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_hostname == NULL) ? R_NilValue : Rf_mkString(_out_hostname ? (const char*)_out_hostname : ""));
...
SEXP R_g_get_charset(void) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_charset == NULL) ? R_NilValue : Rf_mkString(_out_charset ? (const char*)_out_charset : ""));
...
SEXP R_g_get_filename_charsets(void) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_filename_charsets == NULL) ? R_NilValue : Rf_mkString(_out_filename_charsets ? (const char*)_out_filename_charsets : ""));
...
SEXP R_g_prefix_error_literal(SEXP s1) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, (_out_err == NULL) ? R_NilValue : R_MakeExternalPtr((void*)(_out_err), R_NilValue, R_NilValue));
...
SEXP R_g_propagate_error(SEXP s1) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, (_out_dest == NULL) ? R_NilValue : R_MakeExternalPtr((void*)(_out_dest), R_NilValue, R_NilValue));
...
SEXP R_g_ref_count_dec(void) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, Rf_ScalarInteger((int)(size_t)(_out_rc)));
...
SEXP R_g_ref_count_inc(void) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(size_t)(_out_rc)));
...
SEXP R_g_shell_parse_argv(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 2, (_out_argvp == NULL) ? R_NilValue : Rf_mkString(_out_argvp ? (const char*)_out_argvp : ""));
...
SEXP R_g_spawn_async(SEXP s1, SEXP s2, SEXP s3, SEXP s4, SEXP s5, SEXP s6) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, R_MakeExternalPtr((void*)(&_out_child_pid), R_NilValue, R_NilValue));
...
SEXP R_g_spawn_async_with_pipes_and_fds(SEXP s1, SEXP s2, SEXP s3, SEXP s4, SEXP s5, SEXP s6, SEXP s7, SEXP s8, SEXP s9, SEXP s10, SEXP s11, SEXP s12) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, R_MakeExternalPtr((void*)(&_out_child_pid_out), R_NilValue, R_NilValue));
...
SEXP R_g_spawn_command_line_sync(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_standard_output == NULL) ? R_NilValue : Rf_ScalarInteger((int)(_out_standard_output)));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("standard_output"));
  SET_VECTOR_ELT(_ans, 2, (_out_standard_error == NULL) ? R_NilValue : Rf_ScalarInteger((int)(_out_standard_error)));
...
SEXP R_g_str_tokenize_and_fold(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, (_ret == NULL) ? R_NilValue : Rf_mkString(_ret ? (const char*)_ret : ""));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_ascii_alternates == NULL) ? R_NilValue : Rf_mkString(_out_ascii_alternates ? (const char*)_out_ascii_alternates : ""));
...
SEXP R_g_utf8_validate(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_end == NULL) ? R_NilValue : Rf_ScalarInteger((int)(_out_end)));
