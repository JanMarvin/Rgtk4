...
SEXP R_g_closure_invoke(SEXP s1, SEXP s2, SEXP s3, SEXP s4) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, R_MakeExternalPtr((void*)(&_out_return_value), R_NilValue, R_NilValue));
...
SEXP R_g_enum_complete_type_info(SEXP s1, SEXP s2) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, R_MakeExternalPtr((void*)(&_out_info), R_NilValue, R_NilValue));
...
SEXP R_g_signal_query(SEXP s1) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, R_MakeExternalPtr((void*)(&_out_query), R_NilValue, R_NilValue));
