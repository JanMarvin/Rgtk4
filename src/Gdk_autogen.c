...
SEXP R_gdk_clipboard_read_finish(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, (_ret == NULL) ? R_NilValue : R_MakeExternalPtr((void*)(_ret), R_NilValue, R_NilValue));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_out_mime_type == NULL) ? R_NilValue : Rf_mkString(_out_out_mime_type ? (const char*)_out_out_mime_type : ""));
...
SEXP R_gdk_display_map_keycode(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_keys == NULL) ? R_NilValue : R_MakeExternalPtr((void*)(_out_keys), R_NilValue, R_NilValue));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("keys"));
  SET_VECTOR_ELT(_ans, 2, (_out_keyvals == NULL) ? R_NilValue : Rf_ScalarInteger((int)(size_t)(_out_keyvals)));
...
SEXP R_gdk_display_translate_key(SEXP s1, SEXP s2, SEXP s3, SEXP s4) {
  ...
  SET_VECTOR_ELT(_ans, 4, R_MakeExternalPtr((void*)(&_out_consumed), R_NilValue, R_NilValue));
...
SEXP R_gdk_event_get_axes(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, (_out_axes == NULL) ? R_NilValue : Rf_ScalarReal((double)(size_t)(_out_axes)));
...
SEXP R_gdk_key_event_get_match(SEXP s1) {
  ...
  SET_VECTOR_ELT(_ans, 1, Rf_ScalarInteger((int)(_out_keyval)));
  SET_STRING_ELT(_ans_names, 1, Rf_mkChar("keyval"));
  SET_VECTOR_ELT(_ans, 2, R_MakeExternalPtr((void*)(&_out_modifiers), R_NilValue, R_NilValue));
...
SEXP R_gdk_monitor_get_geometry(SEXP s1) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, R_MakeExternalPtr((void*)(&_out_geometry), R_NilValue, R_NilValue));
...
SEXP R_gdk_rectangle_intersect(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 0, Rf_ScalarInteger((int)(_ret)));
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("result"));
  SET_VECTOR_ELT(_ans, 1, R_MakeExternalPtr((void*)(&_out_dest), R_NilValue, R_NilValue));
...
SEXP R_gdk_rectangle_union(SEXP s1, SEXP s2) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, R_MakeExternalPtr((void*)(&_out_dest), R_NilValue, R_NilValue));
...
SEXP R_gdk_surface_get_device_position(SEXP s1, SEXP s2) {
  ...
  SET_VECTOR_ELT(_ans, 2, Rf_ScalarInteger((int)(_out_y)));
  SET_STRING_ELT(_ans_names, 2, Rf_mkChar("y"));
  SET_VECTOR_ELT(_ans, 3, R_MakeExternalPtr((void*)(&_out_mask), R_NilValue, R_NilValue));
