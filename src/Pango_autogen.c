...
SEXP R_pango_attr_list_filter(SEXP s1, SEXP s2, SEXP s3) {
  PangoAttrList* v1 = (PangoAttrList*)(get_ptr(s1)); (void)v1;
  PangoAttrFilterFunc v2 = (PangoAttrFilterFunc)(get_ptr(s2)); (void)v2;
  gpointer v3 = (s3 != R_NilValue) ? (gpointer)(get_ptr(s3)) : NULL; (void)v3;
  gconstpointer _ret = (gconstpointer)pango_attr_list_filter(v1, v2, v3);
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, (_ret == NULL) ? R_NilValue : make_gobject_ptr((gpointer)_ret));
  if (VECTOR_ELT(_ans, 0) != R_NilValue) {
...
SEXP R_pango_attr_shape_new_with_data(SEXP s1, SEXP s2, SEXP s3, SEXP s4, SEXP s5) {
  const PangoRectangle* v1 = (const PangoRectangle*)(get_ptr(s1)); (void)v1;
  const PangoRectangle* v2 = (const PangoRectangle*)(get_ptr(s2)); (void)v2;
  gpointer v3 = (s3 != R_NilValue) ? (gpointer)(get_ptr(s3)) : NULL; (void)v3;
  PangoAttrDataCopyFunc v4 = (s4 != R_NilValue) ? (PangoAttrDataCopyFunc)(get_ptr(s4)) : NULL; (void)v4;
  GDestroyNotify v5 = (s5 != R_NilValue) ? (GDestroyNotify)(get_ptr(s5)) : NULL; (void)v5;
  gconstpointer _ret = (gconstpointer)pango_attr_shape_new_with_data(v1, v2, v3, v4, v5);
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, (_ret == NULL) ? R_NilValue : make_gobject_ptr((gpointer)_ret));
  if (VECTOR_ELT(_ans, 0) != R_NilValue) {
...
SEXP R_pango_font_get_glyph_extents(SEXP s1, SEXP s2) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 2));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 2));
  SET_VECTOR_ELT(_ans, 0, make_boxed_struct(&_out_ink_rect, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 0) != R_NilValue) {
    Rf_setAttrib(VECTOR_ELT(_ans, 0), Rf_install("glib_type"), Rf_mkString("Rectangle"));
  }
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("ink_rect"));
  SET_VECTOR_ELT(_ans, 1, make_boxed_struct(&_out_logical_rect, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 1) != R_NilValue) {
...
SEXP R_pango_fontset_foreach(SEXP s1, SEXP s2, SEXP s3) {
  PangoFontset* v1 = (PangoFontset*)(get_ptr(s1)); (void)v1;
  PangoFontsetForeachFunc v2 = (PangoFontsetForeachFunc)(get_ptr(s2)); (void)v2;
  gpointer v3 = (s3 != R_NilValue) ? (gpointer)(get_ptr(s3)) : NULL; (void)v3;
  pango_fontset_foreach(v1, v2, v3);
  return R_NilValue;
}
...
SEXP R_pango_layout_get_caret_pos(SEXP s1, SEXP s2) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 2));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 2));
  SET_VECTOR_ELT(_ans, 0, make_boxed_struct(&_out_strong_pos, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 0) != R_NilValue) {
    Rf_setAttrib(VECTOR_ELT(_ans, 0), Rf_install("glib_type"), Rf_mkString("Rectangle"));
  }
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("strong_pos"));
  SET_VECTOR_ELT(_ans, 1, make_boxed_struct(&_out_weak_pos, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 1) != R_NilValue) {
    Rf_setAttrib(VECTOR_ELT(_ans, 1), Rf_install("glib_type"), Rf_mkString("Rectangle"));
  }
...
SEXP R_pango_layout_index_to_pos(SEXP s1, SEXP s2) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, make_boxed_struct(&_out_pos, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 0) != R_NilValue) {
    Rf_setAttrib(VECTOR_ELT(_ans, 0), Rf_install("glib_type"), Rf_mkString("Rectangle"));
  }
...
SEXP R_pango_layout_iter_get_char_extents(SEXP s1) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, make_boxed_struct(&_out_logical_rect, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 0) != R_NilValue) {
    Rf_setAttrib(VECTOR_ELT(_ans, 0), Rf_install("glib_type"), Rf_mkString("Rectangle"));
  }
...
SEXP R_pango_matrix_transform_pixel_rectangle(SEXP s1) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 1));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 1));
  SET_VECTOR_ELT(_ans, 0, make_boxed_struct(&_out_rect, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 0) != R_NilValue) {
    Rf_setAttrib(VECTOR_ELT(_ans, 0), Rf_install("glib_type"), Rf_mkString("Rectangle"));
  }
...
SEXP R_pango_extents_to_pixels(void) {
  ...
  SEXP _ans = PROTECT(Rf_allocVector(VECSXP, 2));
  SEXP _ans_names = PROTECT(Rf_allocVector(STRSXP, 2));
  SET_VECTOR_ELT(_ans, 0, make_boxed_struct(&_out_inclusive, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 0) != R_NilValue) {
    Rf_setAttrib(VECTOR_ELT(_ans, 0), Rf_install("glib_type"), Rf_mkString("Rectangle"));
  }
  SET_STRING_ELT(_ans_names, 0, Rf_mkChar("inclusive"));
  SET_VECTOR_ELT(_ans, 1, make_boxed_struct(&_out_nearest, sizeof(PangoRectangle)));
  if (VECTOR_ELT(_ans, 1) != R_NilValue) {
    Rf_setAttrib(VECTOR_ELT(_ans, 1), Rf_install("glib_type"), Rf_mkString("Rectangle"));
  }
